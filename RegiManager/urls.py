...
from core.insurance_report_views import (
    export_insurance_agent_production_pdf,
    export_insurance_aging_pdf,
    export_insurance_book_pdf,
    export_insurance_cashout_pdf,
    export_insurance_commission_register_pdf,
    export_insurance_compliance_pdf,
    export_insurance_payment_receipt_pdf,
    export_insurance_quote_conversion_pdf,
    export_insurance_remittance_pdf,
    export_insurance_targets_pdf,
    export_insurance_unearned_pdf,
)
...
urlpatterns = [
    ...
    path(
        'api/client/documents/<str:kind>/<int:document_id>/preview/',
        ClientDocumentPreviewView.as_view(),
        name='api-client-document-preview',
    ),
    ...
    path('api/owner/insurance/summary/', OwnerInsuranceSummaryView.as_view(), name='api-owner-insurance-summary'),
    ...
    path(
        ...
        agent_portal_owner_review,
        name="agent-portal-owner-review",
    ),
    ...
    path("dashboard/agents/<int:membership_id>/", agent_profile, name="agent-profile"),
    ...
    path(
        "dashboard/referrals/documents/<int:document_id>/delete/",
        delete_referral_document,
        name="delete-referral-document",
    ),
    ...
    path(
        "dashboard/clients/<int:client_id>/app-access/test/",
        test_client_app_login,
        name="test-client-app-login",
    ),
    ...
    path("dashboard/docs/<int:doc_id>/rename/", rename_document, name="rename-document"),
    ...
    path(
        "dashboard/insurance-quotes/documents/<int:document_id>/download/",
        download_quote_lead_document,
        name="download-quote-lead-document",
    ),
    path(
    ...
    path("dashboard/spaces/insurance/ledger/pdf/", export_insurance_ledger_pdf, name="export-insurance-ledger-pdf"),
    path("dashboard/spaces/insurance/reports/remittance.pdf", export_insurance_remittance_pdf, name="export-insurance-remittance-pdf"),
    path("dashboard/spaces/insurance/reports/receipt/<int:payment_id>.pdf", export_insurance_payment_receipt_pdf, name="export-insurance-payment-receipt-pdf"),
    path("dashboard/spaces/insurance/reports/producer.pdf", export_insurance_agent_production_pdf, name="export-insurance-agent-production-pdf"),
    path("dashboard/spaces/insurance/reports/unearned.pdf", export_insurance_unearned_pdf, name="export-insurance-unearned-pdf"),
    path("dashboard/spaces/insurance/reports/cashout.pdf", export_insurance_cashout_pdf, name="export-insurance-cashout-pdf"),
    path("dashboard/spaces/insurance/reports/book.pdf", export_insurance_book_pdf, name="export-insurance-book-pdf"),
    path("dashboard/spaces/insurance/reports/aging.pdf", export_insurance_aging_pdf, name="export-insurance-aging-pdf"),
    path("dashboard/spaces/insurance/reports/quotes.pdf", export_insurance_quote_conversion_pdf, name="export-insurance-quote-conversion-pdf"),
    ...
    path("dashboard/email-marketing/<int:list_id>/assign-task/", email_marketing_assign_task, name="email-marketing-assign-task"),
