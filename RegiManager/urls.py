...
from core.views import (
    ...
    edit_insurance_company_license,
    edit_psb_license,
...
from core.tlc_views import (
    ...
    add_tlc_endorsement,
    record_tlc_cancellation,
    add_tlc_remittance,
    add_tlc_document,
    generate_tlc_installment_schedule,
    schedule_tlc_reminders,
...
from core.tlc_edit_views import (
    ...
    edit_tlc_reinstatement,
    edit_tlc_endorsement,
    edit_tlc_dmv_service,
    edit_tlc_remittance,
    edit_tlc_document,
    edit_tlc_commission_rule,
    edit_tlc_finance_company,
    edit_tlc_carrier_statement,
)
...
urlpatterns = [
    ...
    path("dashboard/spaces/insurance/daily-payment/<int:transaction_id>/edit/", edit_daily_payment, name="edit-daily-payment"),
    ...
    path(
        "dashboard/spaces/insurance/company/<int:company_id>/license/",
        edit_insurance_company_license,
        name="edit-insurance-company-license",
    ),
    ...
    path("dashboard/spaces/tlc/policy/<int:policy_id>/cancellation/record/", record_tlc_cancellation, name="record-tlc-cancellation"),
    ...
    path("dashboard/spaces/tlc/policy/<int:policy_id>/schedule/generate/", generate_tlc_installment_schedule, name="generate-tlc-installment-schedule"),
    path("dashboard/spaces/tlc/policy/<int:policy_id>/reminders/schedule/", schedule_tlc_reminders, name="schedule-tlc-reminders"),
    ...
    path("dashboard/spaces/tlc/endorsement/<int:endorsement_id>/edit/", edit_tlc_endorsement, name="edit-tlc-endorsement"),
    path("dashboard/spaces/tlc/dmv-service/<int:service_id>/edit/", edit_tlc_dmv_service, name="edit-tlc-dmv-service"),
    path("dashboard/spaces/tlc/remittance/<int:remittance_id>/edit/", edit_tlc_remittance, name="edit-tlc-remittance"),
    path("dashboard/spaces/tlc/document/<int:document_id>/edit/", edit_tlc_document, name="edit-tlc-document"),
    path("dashboard/spaces/tlc/commission-rule/<int:rule_id>/edit/", edit_tlc_commission_rule, name="edit-tlc-commission-rule"),
    path("dashboard/spaces/tlc/finance-company/<int:company_id>/edit/", edit_tlc_finance_company, name="edit-tlc-finance-company"),
    path("dashboard/spaces/tlc/carrier-statement/<int:statement_id>/edit/", edit_tlc_carrier_statement, name="edit-tlc-carrier-statement"),
