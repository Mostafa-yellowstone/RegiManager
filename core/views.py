...
def service_receipt_pdf(request, service_id):
    ...
    receipt_display = format_receipt_number_display(service_record)
    ...
    x += 85
    draw_box(x, y, 80, 16, "Receipt number", receipt_display)
    x += 85
    ...
    sum_words = dollars_to_words(grand_total)
    pdf.setFont("Helvetica", 8.5)
    pdf.drawString(margin_x, y, "The sum of")
    sum_x = margin_x + 62
    sum_w = 300
