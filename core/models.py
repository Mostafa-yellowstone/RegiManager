...
class ClientIntake(models.Model):
    ...
    # Dealer / referral partner (when source is dealer or referral)
    ...
    # Linked Referral Space partner (when source is dealer or referral)
...
class DailyPaymentTransaction(models.Model):
    ...
    section_2119 = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        null=True,
        blank=True,
